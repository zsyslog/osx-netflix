...
- (void)applicationDidFinishLaunching:(NSNotification *)aNotification {
    ...
    _webView.CustomUserAgent = @"Mozilla/5.0 (Macintosh; Intel Mac OS X 10_10_2) AppleWebKit/600.4.10 (KHTML, like Gecko) Version/8.0.4 Safari/600.4.10";
    ...
    [_window setContentView:_webView]; // <---- _window.ContentView = _webView;

    // calculate the WebView size
    NSRect newWebViewRect = NSMakeRect(0, 0, NSWidth(screenRect), NSHeight(screenRect));
